 ...
 * @version 创建时间：2014年12月14日 下午3:04:23
 * 类说明
 */
import java.util.*;
import java.awt.*;
...
public class CalendarFrame extends JFrame implements ActionListener {
     ...
     JTextField selectYear;
     static CalendarBean calendar;
     JLabel showMessage=new JLabel("",JLabel.CENTER); 
     int year=2005,month=2;
        ...
        selectYear.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
			        	calendar.setYear(Integer.valueOf(selectYear.getText()));
